...
class BookmarksFragment : BaseFragment<BookmarksViewModel>() {
    ...
    private val articlesAdapter =
        ArticlesAdapter(::onArticleClickListener, ::onBookmarkClickListener)

    private fun onArticleClickListener(item: ArticleItemData) {
    ...
    private fun onBookmarkClickListener(id: String, isChecked: Boolean) {
        ...
        Log.e(
            "BookmarksFragment",
            "click on bookmark checkable image: article id $id, is checked: $checked"
        )
